function aiffwrite(file, x, sRate)

%aiffwrite	Write a sound file in Audio Interchange File Format.
%
% aiffwrite(file,x,sRate)
...
if (nRows(x) < nCols(x) & nRows(x) > 16)
  disp('aiffwrite: warning: multiple channels must be in columns.')
end
